  ...
  return (
    <div className='container mx-auto'>
        ...
        <div className='flex justify-center items-center h-screen'>
            <div className={`${styles.glass} ${extend.glass}`} style={{width:'40%',height:'98%'}}>
                <div className="title flex flex-col items-center -my-5">
                    <h4 className='font-bold text-5xl'>Profile</h4>
                ...
                <form action="" className='py-1' onSubmit={formik.handleSubmit}>
                    ...
                    <div className="textbox flex flex-col items-center gap-6">
                      ...
                      <div className="name flex w-3/4 gap-10">
                      <input {...formik.getFieldProps('mobile')} className={`${styles.textbox} ${extend.textbox}`} type="text" placeholder='Ph Number' />
                      <input {...formik.getFieldProps('email')} className={`${styles.textbox} ${extend.textbox}`} type="text" placeholder='johndoe@email.com' />
                      </div>
                    ...
                    <div className="text-center py-4">
                        <span className='text-gray-500'>Come back later? <Link className='text-red-500' to={'/'}>Sign out</Link></span>
                    </div>
                </form>
            </div>
        </div>
